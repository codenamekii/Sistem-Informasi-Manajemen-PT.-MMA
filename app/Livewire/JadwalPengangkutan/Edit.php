...
class Edit extends Component
{
    ...
    public function mount(JadwalPengangkutan $jadwalPengangkutan): void
    {
        ...
        $this->tanggal_pengangkutan = $jadwalPengangkutan->tanggal_pengangkutan?->format('Y-m-d') ?? '';
        ...
        $this->tanggal_realisasi    = $jadwalPengangkutan->tanggal_realisasi?->format('Y-m-d') ?? '';
