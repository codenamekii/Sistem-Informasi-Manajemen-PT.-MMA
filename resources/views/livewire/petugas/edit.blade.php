<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <x-page-header title="Edit Petugas" description="Perbarui informasi petugas yang dipilih." class="mb-0" />
        <a href="{{ route('petugas.show', $petugas) }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
        ...
        <div class="px-5 py-4 border-b border-gray-100">
            ...
            <p class="text-xs text-gray-400 mt-0.5">
                ID: <span class="font-mono">{{ $petugas->id }}</span>
            </p>
        </div>
        ...
        <form wire:submit="update" class="px-5 py-6">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-end gap-3 mt-8 pt-5
                ...
                <a href="{{ route('petugas.show', $petugas) }}" class="w-full sm:w-auto text-center px-5 py-2.5 text-sm font-medium
