<div>
  <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-6">
    <x-page-header title="Edit Jadwal Pengangkutan" :description="$kode_jadwal" class="mb-0" />
    <div class="shrink-0">
      <a href="{{ route('jadwal-pengangkutan.show', $jadwal->id) }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium
  ...
  <form wire:submit="save" enctype="multipart/form-data">
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 space-y-6">
      ...
      <div>
        ...
        <input type="text" id="kode_jadwal" wire:model="kode_jadwal" readonly class="bg-gray-100 border border-gray-200 text-gray-500 text-sm rounded-lg
      ...
      <div>
        ...
        <input type="date" id="tanggal_pengangkutan" wire:model="tanggal_pengangkutan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                           focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                           @error('tanggal_pengangkutan') border-red-500 @enderror" />
      ...
      <div>
        ...
        <select id="kerja_sama_id" wire:model="kerja_sama_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                           focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                           @error('kerja_sama_id') border-red-500 @enderror">
      ...
      <div>
        ...
        <select id="armada_id" wire:model="armada_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                           focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
                           @error('armada_id') border-red-500 @enderror">
      ...
      <div>
        ...
        <select id="status" wire:model.live="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                           focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
