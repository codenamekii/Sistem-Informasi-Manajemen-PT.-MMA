<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <x-page-header title="Tambah Kerja Sama"
            description="Isi form berikut untuk menambahkan perjanjian kerja sama baru." class="mb-0" />
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
        ...
        <form wire:submit="save" class="px-5 py-6">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-end gap-3 mt-8 pt-5
                ...
                <a href="{{ route('kerja-sama.index') }}" class="w-full sm:w-auto text-center px-5 py-2.5 text-sm font-medium
