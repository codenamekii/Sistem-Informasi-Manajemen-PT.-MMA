...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
    ...
    <x-stat-card title="Fasilitas Kesehatan" value="8" description="8 baru ditambahkan" color="blue">
        <x-slot:icon>
    ...
    <x-stat-card title="Kerja Sama Aktif" value="7" description="7 baru ditambahkan" color="green">
        <x-slot:icon>
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <x-stat-card title="Jadwal Bulan Ini" value="0" description="Belum ada jadwal untuk bulan ini" color="yellow">
        <x-slot:icon>
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <x-stat-card title="Armada Tersedia" value="2" description="2 armada tersedia" color="purple">
        <x-slot:icon>
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
